package com.hensen.shixiongsdk.Browser.client;
...
/**
 * Custom WebViewClient for BrowserWebView which handles different url schemes.
 * Has listener to communicate with buttons on BrowserLayout.
 */
public class BrowserWebViewClient extends WebViewClient {
    ...
    /**
     * Check whether to have qualified Activity
     *
     * @param intent
     * @param context
     * @return
